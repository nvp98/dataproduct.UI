...
export const Header_TieuHaoLoThoi: ThongKeHeaderColumn[] = [
  ...
  { dataIndex: "macThep", title: "Mác thép", width: 80 },
  { dataIndex: "klGangLong", title: "Gang lỏng", width: 80 },
  ...
  { dataIndex: "chatCaiTienBeMatXi", title: "Chất cải tiến bề mặt xỉ", width: 80 },
  { dataIndex: "chatCaiTienBeMatXi2", title: "Chất cải tiến bề mặt xỉ 2", width: 80 }
];
