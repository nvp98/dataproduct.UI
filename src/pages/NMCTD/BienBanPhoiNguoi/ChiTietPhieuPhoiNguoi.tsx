...
import CTD_BB_Phoinong from "../../../utils/BM_config/CTD_BB_Phoinguoi.json";
import { CheckOutlined, CloseOutlined } from "@ant-design/icons";
import { PheDuyetApi } from "../../../services/PheDuyetApi";

const { Title, Text } = Typography;

const ChiTietPhieuPhoiNguoi = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // const pheDuyetCuaToi = res.pheDuyet?.find(
        //   (pd: any) => pd.nguoiDuyetId === currentUserId
        // );
        // if (pheDuyetCuaToi) {
        //   setDataPheDuyet(pheDuyetCuaToi[0]);
        // }
...
export default ChiTietPhieuPhoiNguoi;
