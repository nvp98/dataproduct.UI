import jsonconfig from "../../../utils/BM_config/CTD_BB_Phoinguoi.json";
...
const TaoPhieuPhoiNguoi = () => {
  ...
  const initData = async () => {
    try {
      ...
      // else {
      //   message.warning("Không tìm thấy phiếu!");
      // }
      ...
      //   ca: 1,
      //   // ngay: "2025-10-11",
      //   // thoiGianDen: "2025-10-10T07:44:59.280Z",
      //   nguoiLap: "",
      //   mayduc: 1,
      //   NgaySX: dayjs("2025-10-11"),
      // };
      // form.setFieldsValue(initialValues);
      // setTableData(getInitialTableData());
      // const params = {
      //   NgaySX: initialValues.NgaySX
      //     ? dayjs(initialValues.NgaySX).format("YYYY-MM-DD")
      //     : dayjs().format("YYYY-MM-DD"),
      //   Ca: initialValues.ca ?? 1,
      //   // Kip: initialValues.kip ?? "1",
      // };
      // const tablePhoiNong = config.layout.find(
      //   (l) => l.sectionType === "table" && l.key === "phoiNongTable"
      // );
...
export default TaoPhieuPhoiNguoi;
