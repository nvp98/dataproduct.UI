import NL_BB_Quangtrunghoa from "../../../utils/BM_config/NL_BB_Quangtrunghoa.json";
import {
  Button,
  Card,
  Col,
...
const VHThanPhunLoCao = () => {
  const config = NL_BB_Quangtrunghoa;
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col>
            <Button
              type="primary"
              icon={<PlusOutlined />}
              onClick={() => navigate("/taophieunhatkyquang")}
            >
              Tạo phiếu mới
            </Button>
          </Col>
...
export default VHThanPhunLoCao;
