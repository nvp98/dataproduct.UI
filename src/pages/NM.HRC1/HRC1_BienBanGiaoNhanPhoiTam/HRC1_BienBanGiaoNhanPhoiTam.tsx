...
import Hrc1SlabTable from "./Hrc1SlabTable";
...
const PhieuListView = ({ type }: { type?: "taoMoi" | "viecdentoi" | "xemphieu" }) => {
  ...
  const { data, loading, pagination, handleFilter, handleClearFilter, onPageChange } =
    usePhieuSearchListHRC({ maBm: BM_CONFIG.HRC1.HRC1_BBGN_PhoiTam as string, fixedFilters });
  ...
  return (
    <div>
      <PhieuFilterCard
        ...
        onCreateClick={() => navigate("/form-bbgnphoitam_hrc1")}
