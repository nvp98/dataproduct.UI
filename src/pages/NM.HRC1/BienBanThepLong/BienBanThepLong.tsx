import HRC1_BB_Theplong from "../../../utils/BM_config/HRC1_BB_Theplong.json";
import {
  Button,
  Card,
  Col,
...
const BienBanThepLong = () => {
  const config = HRC1_BB_Theplong;
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col>
            <Button
              type="primary"
              icon={<PlusOutlined />}
              onClick={() => navigate("/taophieutheplong")}
            >
              Tạo phiếu mới
            </Button>
          </Col>
...
export default BienBanThepLong;
